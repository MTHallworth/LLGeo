...
Determining the sun elevation angle--here called the Zenith angle--for SGAT. A Zenith angle is the angle of the sun with respect to a verticle line. If the sun is directly overhead, the angle is zero. If the sun is on the horizon, the angle is about 90 degrees. For an SGAT analysis it is often best to use a zenith angle from the high end of the distrubution of zenith angles derived from the calibration data. In the example below we take the 95th quantile. Remember that a larger zenith angle means that the sun is lower in the sky.
