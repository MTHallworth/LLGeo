...
Geolight has a simple plot making function called tripMap()

```{r}
ip <- coord(tFirst = twl$Twilight[1:nrow(twl)])

tripMap <- (crds = InitialPath$x, equinox = TRUE, xlim = c(-90,-70), ylim = c(10,50), legend = TRUE)
```

Here is the code to make a figure to show the inital path. 
