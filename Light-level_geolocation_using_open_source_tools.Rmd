...
This function provides a dataframe with both the original twlight times (in column "Twilight") and the edited times (in column "Twilight0").Now that we have adjusted the twilights - we have new information in out `twl` file. 
...
tsimagePoints(twl$Twilight0, offset = 18, pch = 16, cex = 0.5,
              col = ifelse(twl$Rise, "dodgerblue", "firebrick"))
```
